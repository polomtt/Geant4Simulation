...
auto eRositaDetectorConstruction::Construct() -> G4VPhysicalVolume*
{
    ...
    constexpr auto TARGET_HALF_LENGTH{5 * mm};
    constexpr auto TARGET_HALF_DEPTH{50 * um};
    ...
    constexpr auto TRACKER_INITIAL_POSITION_Y{0.0 * cm};
    ...
    G4Sphere * trackerSolid = new G4Sphere("tracker", 10.*cm, 10.*cm+trackerHalfDepth*2., 0*deg,360*deg,0*deg,180*deg);
