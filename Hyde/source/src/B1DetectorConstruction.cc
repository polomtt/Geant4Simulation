...
/***************************/   
    ...
    for( int i=1 ; i < (nHole_x) ; i++)
    {
      ...
      { 
        float raggio_interno = radius_hole-5.0e-7*m;
        G4Tubs* detector_hole =  new G4Tubs("hole",raggio_interno,radius_hole,depth_hole,0*deg,360*deg);
        G4Tubs* detector_hole_litium =  new G4Tubs("hole",raggio_interno-free_space_hole,radius_hole-free_space_hole,depth_hole-free_space_hole,0*deg,360*deg);
